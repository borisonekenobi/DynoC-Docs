...
import {V0_3_16Page} from './pages/v0.3.16/v0_3_16.page';
...
import {WrongRoutePage} from './pages/wrong-route/wrong-route.page';

export const routes: Routes = [
	{path: '', title: 'Home | DynoC Documentation', component: HomePage},
	{
		path: 'getting-started',
		title: 'Getting Started | DynoC Documentation',
		component: GettingStartedPage,
	},
	{
		path: 'documentation',
		title: 'Documentation | DynoC Documentation',
	...
	{
		path: 'downloads',
		title: 'Downloads | DynoC Documentation',
		component: DownloadsPage,
	},
	{
		path: 'examples',
		title: 'Examples | DynoC Documentation',
		component: ExamplesPage,
	},
	{
		path: 'contributing',
		title: 'ContributingPage | DynoC Documentation',
		component: ContributingPage,
	},
	{
		path: '**',
		title: '404 Not Found | DynoC Documentation',
